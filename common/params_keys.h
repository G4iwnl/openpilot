...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoTurnControlSpeedTurn", {PERSISTENT, INT, "50"}},
    ...
    {"AutoNaviSpeedBumpTime", {PERSISTENT, INT, "5"}},
    {"AutoNaviSpeedBumpSpeed", {PERSISTENT, INT, "25"}},
    {"AutoNaviSpeedDecelRate", {PERSISTENT, INT, "200"}},
    ...
    {"StoppingAccel", {PERSISTENT, INT, "-4"}},
    ...
    {"LatSmoothSec", {PERSISTENT, INT, "10"}},
    {"LatSuspendAngleDeg", {PERSISTENT, INT, "300"}},
    {"CruiseOnDist", {PERSISTENT, INT, "0"}},

    {"CruiseMaxVals0", {PERSISTENT, INT, "130"}},
    {"CruiseMaxVals1", {PERSISTENT, INT, "130"}},
    {"CruiseMaxVals2", {PERSISTENT, INT, "80"}},
    {"CruiseMaxVals3", {PERSISTENT, INT, "50"}},
    {"CruiseMaxVals4", {PERSISTENT, INT, "35"}},
    {"CruiseMaxVals5", {PERSISTENT, INT, "30"}},
    ...
    {"VEgoStopping", {PERSISTENT, INT, "2"}},

    {"RadarReactionFactor", {PERSISTENT, INT, "80"}},
    ...
    {"TFollowGap3", {PERSISTENT, INT, "150"}},
    ...
    {"TrafficStopDistanceAdjust", {PERSISTENT, INT, "-120"}},
    ...
    {"LatMpcSteeringRateCost", {PERSISTENT, INT, "5"}},
    ...
    {"LateralTorqueFriction", {PERSISTENT, INT, "30"}},
    {"LateralTorqueKpV", {PERSISTENT, INT, "140"}},
    {"LateralTorqueKiV", {PERSISTENT, INT, "60"}},
    ...
    {"CustomSteerDeltaDown", {PERSISTENT, INT, "3"}},
