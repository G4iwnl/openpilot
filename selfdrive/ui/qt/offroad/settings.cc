...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  latLongToggles->addItem(new CValueControl("TempSteerDeltaUp", "LAT: TempSteerDeltaUp(0)", "임시 SteerDeltaUp, Down을 모두 0으로하면 딜레이를 사용하지 않습니다.", "../assets/offroad/icon_logic.png", 0, 50, 1));
  latLongToggles->addItem(new CValueControl("TempSteerDeltaDown", "LAT: TempSteerDeltaDown(0)", "임시 SteerDeltaUp, Down을 모두 0으로하면 딜레이를 사용하지 않습니다.", "../assets/offroad/icon_logic.png", 0, 50, 1));
  ...
  startToggles->addItem(new CValueControl("cruiselateral", "lfa off on disengage", "", "../assets/offroad/icon_road.png", 0, 1, 1));
  ...
  speedToggles->addItem(new CValueControl("DecreaseHDA", "AutoDecrease From CAN-FD signal", "0:사용안함, 1:APN없이 HDA로 감속", "../assets/offroad/icon_road.png", 0, 1, 1));
  speedToggles->addItem(new CValueControl("HDAtollgate", "CANFD signal tollgate decel speed(80)", "0: not decel 1~ : decel", "../assets/offroad/icon_road.png", 0, 200, 10));
  ...
  speedToggles->addItem(new CValueControl("AutoNaviSpeedCtrlMode", "SpeedCameraDecelMode", "0:감속안함,1:과속카메라,2:+사고방지턱,3:+이동식카메라", "../assets/offroad/icon_road.png", 0, 3, 1));
  ...
  speedToggles->addItem(new CValueControl("LaneChangeDelay", "LaneChangeDelay", "x0.1초 단위입니다. 0으로하면 사용하지 않습니다.", "../assets/offroad/icon_road.png", 0, 50, 1));
