...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  startToggles->addItem(new CValueControl("hudfrontboxshape", "Hud Front Box Shape(0)", "0: car, 1: bicycle, 2: truck, 3: person, 4: cone", "../assets/offroad/icon_shell.png", 0, 4, 1));
