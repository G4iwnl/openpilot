...
class CarControllerParams:
  ...
  ANGLE_TORQUE_UP_RATE = 20 #2  # Indicates how fast the torque ramps up after user intervention.
  ANGLE_TORQUE_DOWN_RATE = 40  #4 Indicates how fast the torque ramps down during user intervention (handing off).
