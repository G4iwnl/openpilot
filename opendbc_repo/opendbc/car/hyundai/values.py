...
class CarControllerParams:
  ...
  ANGLE_TORQUE_UP_RATE = 5 #2  # Indicates how fast the torque ramps up after user intervention.
  ANGLE_TORQUE_DOWN_RATE = 8  #4 Indicates how fast the torque ramps down during user intervention (handing off).
