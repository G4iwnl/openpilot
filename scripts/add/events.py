...
def comm_issue_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  ...
  return NoEntryAlert(msg, alert_text_1="프로세스 통신 오류")
...
def overheat_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  ...
  return NormalPermanentAlert("콤마 과열", f"{temp:.0f} °C")
...
def high_cpu_usage_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  ...
  return NormalPermanentAlert("CPU 과부화", f"{x}% used")


def modeld_lagging_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  return NormalPermanentAlert("주행모델 지연", f"{sm['modelV2'].frameDropPerc:.1f}% frames dropped")
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.selfdriveInitializing: {
    ET.NO_ENTRY: NoEntryAlert("오기사 초기화"),
  },
  ...
  EventName.startupNoControl: {
    ET.PERMANENT: StartupAlert("대쉬캠 모드"),
    ET.NO_ENTRY: NoEntryAlert("대쉬캠 모드"),
  },

  EventName.startupNoCar: {
    ET.PERMANENT: StartupAlert("대쉬캠 모드 : 호환되지 않는 차량"),
  },

  EventName.startupNoSecOcKey: {
    ET.PERMANENT: NormalPermanentAlert("대쉬캠 모드",
                                       "보안키 사용불가",
  ...
  EventName.fanMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("FAN 오작동", "콤마를 점검하세요"),
  },
  ...
  EventName.cameraMalfunction: {
    ...
    ET.NO_ENTRY: NoEntryAlert("카메라 오류: 콤마를 재부팅 하세요"),
  },
  # Camera framerate too low
  EventName.cameraFrameRate: {
    ET.PERMANENT: NormalPermanentAlert("카메라 프레임 낮음", "콤마를 재부팅 하세요"),
    ET.SOFT_DISABLE: soft_disable_alert("카메라 프레임 낮음"),
    ET.NO_ENTRY: NoEntryAlert("카메라 프레임 낮음", "콤마를 재부팅 하세요"),
  },
  ...
  EventName.parkBrake: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage),
    ET.NO_ENTRY: NoEntryAlert("EPB 해제하세요"),
  },
  ...
  EventName.overheat: {
    ...
    ET.SOFT_DISABLE: soft_disable_alert("콤마 과열"),
    ET.NO_ENTRY: NoEntryAlert("콤마 과열"),
  },

  EventName.wrongGear: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.disengage), #carrot
    #ET.SOFT_DISABLE: user_soft_disable_alert("주행기어로 변경하세요"),
    ET.NO_ENTRY: NoEntryAlert("주행기어로 변경하세요"),
  },
  ...
  EventName.calibrationInvalid: {
    ...
    ET.SOFT_DISABLE: soft_disable_alert("캘리브레이션 오류 : 콤마 위치 변경 후 캘리브레이션을 다시 하세요"),
    ET.NO_ENTRY: NoEntryAlert("캘리브레이션 오류 : 콤마 위치 변경 후 캘리브레이션을 다시 하세요"),
  },
  ...
  EventName.calibrationRecalibrating: {
    ET.PERMANENT: calibration_incomplete_alert,
    ET.SOFT_DISABLE: soft_disable_alert("콤마 위치변경이 감지되어 캘리브레이션이 다시 진행중입니다"),
    ET.NO_ENTRY: NoEntryAlert("콤마 위치변경 감지되어 캘리브레이션이 다시 진행중입니다"),
  },
  ...
  EventName.commIssueAvgFreq: {
    ET.SOFT_DISABLE: soft_disable_alert("콤마 통신속도 오류"),
    ET.NO_ENTRY: NoEntryAlert("콤마 통신속도 오류"),
  },

  EventName.selfdrivedLagging: {
    ET.SOFT_DISABLE: soft_disable_alert("시스템 지연됨"),
    ET.NO_ENTRY: NoEntryAlert("Selfdrive 프로세스 지연됨: 콤마를 재부팅 하세요"),
  },
  ...
  EventName.radarTempUnavailable: {
    ET.SOFT_DISABLE: soft_disable_alert("레이더 사용 불가"),
    ET.NO_ENTRY: NoEntryAlert("레이더 사용 불가"),
  },
  ...
  EventName.deviceFalling: {
    ET.SOFT_DISABLE: soft_disable_alert("콤마가 떨어짐"),
    ET.NO_ENTRY: NoEntryAlert("콤마가 떨어짐"),
  },

  EventName.lowMemory: {
    ET.SOFT_DISABLE: soft_disable_alert("메모리 부족 : 콤마를 재부팅 하세요"),
    ET.PERMANENT: low_memory_alert,
    ET.NO_ENTRY: NoEntryAlert("메모리 부족 : 콤마를 재부팅 하세요"),
  },
  ...
  EventName.usbError: {
    ET.SOFT_DISABLE: soft_disable_alert("USB 오류 : 콤마를 재부팅 하세요"),
    ET.PERMANENT: NormalPermanentAlert("USB 오류 : 콤마를 재부팅 하세요", ""),
    ET.NO_ENTRY: NoEntryAlert("USB 오류 : 콤마를 재부팅 하세요"),
  },
  ...
  EventName.steerUnavailable: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("LKAS 오류 : 콤마를 재가동 하세요"),
    ET.PERMANENT: NormalPermanentAlert("LKAS 오류 : 콤마를 재가동 하세요"),
    ET.NO_ENTRY: NoEntryAlert("LKAS 오류 : 콤마를 재가동 하세요"),
  },
  ...
  EventName.reverseGear: {
    ...
    ET.SOFT_DISABLE: SoftDisableAlert("후진 중"),
  ...
  EventName.relayMalfunction: {
    ...
    ET.PERMANENT: NormalPermanentAlert("하네스 릴레이 오작동", "콤마를 점검하세요"),
